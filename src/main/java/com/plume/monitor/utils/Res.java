...
public final class Res {
	...
	public String getCardStatus(int status) {
		String statusString = "";
		switch(status) {
			case NetSDKLib.NET_ACCESSCTLCARD_STATE.NET_ACCESSCTLCARD_STATE_UNKNOWN:   // 未知
				statusString = bundle.getString("STATE_UNKNOWN");
				break;
			case NetSDKLib.NET_ACCESSCTLCARD_STATE.NET_ACCESSCTLCARD_STATE_NORMAL:   // 正常
				statusString = bundle.getString("STATE_NORMAL");
				break;
			case NetSDKLib.NET_ACCESSCTLCARD_STATE.NET_ACCESSCTLCARD_STATE_LOSE:   // 挂失
				statusString = bundle.getString("STATE_LOSE");
				break;
			case NetSDKLib.NET_ACCESSCTLCARD_STATE.NET_ACCESSCTLCARD_STATE_LOGOFF:   // 注销
				statusString = bundle.getString("STATE_LOGOFF");
				break;
			case NetSDKLib.NET_ACCESSCTLCARD_STATE.NET_ACCESSCTLCARD_STATE_FREEZE:   // 冻结
				statusString = bundle.getString("STATE_FREEZE");
				break;
			case NetSDKLib.NET_ACCESSCTLCARD_STATE.NET_ACCESSCTLCARD_STATE_ARREARAGE:   // 欠费
				statusString = bundle.getString("STATE_ARREARS"); 
				break;
			case NetSDKLib.NET_ACCESSCTLCARD_STATE.NET_ACCESSCTLCARD_STATE_OVERDUE:  // 逾期
				statusString = bundle.getString("STATE_OVERDUE");
				break;
			case NetSDKLib.NET_ACCESSCTLCARD_STATE.NET_ACCESSCTLCARD_STATE_PREARREARAGE:  // 预欠费
	...
	public int getCardStatusInt(int index) {
		...
		switch(index) {
			case 0:   // 未知
				status = NetSDKLib.NET_ACCESSCTLCARD_STATE.NET_ACCESSCTLCARD_STATE_UNKNOWN;
				break;
			case 1:   // 正常
				status = NetSDKLib.NET_ACCESSCTLCARD_STATE.NET_ACCESSCTLCARD_STATE_NORMAL;
				break;
			case 2:   // 挂失
				status = NetSDKLib.NET_ACCESSCTLCARD_STATE.NET_ACCESSCTLCARD_STATE_LOSE;
				break;
			case 3:   // 注销
				status = NetSDKLib.NET_ACCESSCTLCARD_STATE.NET_ACCESSCTLCARD_STATE_LOGOFF;
				break;
			case 4:   // 冻结
				status = NetSDKLib.NET_ACCESSCTLCARD_STATE.NET_ACCESSCTLCARD_STATE_FREEZE;
				break;
			case 5:   // 欠费
				status = NetSDKLib.NET_ACCESSCTLCARD_STATE.NET_ACCESSCTLCARD_STATE_ARREARAGE;
				break;
			case 6:  // 逾期
				status = NetSDKLib.NET_ACCESSCTLCARD_STATE.NET_ACCESSCTLCARD_STATE_OVERDUE;
				break;
			case 7:  // 预欠费
				status = NetSDKLib.NET_ACCESSCTLCARD_STATE.NET_ACCESSCTLCARD_STATE_PREARREARAGE;
				break;
			default:
				status = NetSDKLib.NET_ACCESSCTLCARD_STATE.NET_ACCESSCTLCARD_STATE_UNKNOWN;
				break;		
	...
	public String getCardType(int type) {
		...
		switch(type) {
			case NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_UNKNOWN:  // 未知
				cardTypeString = bundle.getString("CARD_UNKNOW");
				break;
			case NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_GENERAL:  // 一般卡
				cardTypeString = bundle.getString("CARD_GENERAL");
				break;
			case NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_VIP:      // VIP卡
				cardTypeString = bundle.getString("CARD_VIP");
				break;
			case NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_GUEST:    // 来宾卡
				cardTypeString = bundle.getString("CARD_GUEST");
				break;
			case NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_PATROL:   // 巡逻卡
				cardTypeString = bundle.getString("CARD_PATROL");
				break;
			case NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_BLACKLIST: // 黑名单卡
				cardTypeString = bundle.getString("CARD_BACKLIST");
				break;
			case NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_CORCE:     // 胁迫卡
				cardTypeString = bundle.getString("CARD_COERCE");
				break;
			case NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_POLLING:   // 巡检卡
				cardTypeString = bundle.getString("CARD_POLLING");
				break;
			case NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_MOTHERCARD: // 母卡
	...
	public int getCardTypeInt(int index) {
		...
		switch(index) {
			case 0:
				type = NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_UNKNOWN;
				break;
			case 1:
				type = NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_GENERAL;
				break;
			case 2:
				type = NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_VIP;
				break;
			case 3:
				type = NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_GUEST;
				break;
			case 4:
				type = NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_PATROL;
				break;
			case 5:
				type = NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_BLACKLIST;
				break;
			case 6:
				type = NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_CORCE;
				break;
			case 7:
				type = NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_POLLING;
				break;
			case 8:
				type = NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_MOTHERCARD;
				break;
			default:
				type = NetSDKLib.NET_ACCESSCTLCARD_TYPE.NET_ACCESSCTLCARD_TYPE_UNKNOWN;
				break;
